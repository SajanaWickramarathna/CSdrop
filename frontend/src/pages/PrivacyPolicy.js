    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-gray-100 text-gray-800">
      ...
      <section className="py-16 px-6 sm:px-16 lg:px-32">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md p-8 space-y-6">
          ...
          <p>
            DROPship is committed to protecting your privacy. This Privacy
          ...
          <p>
            ...
            contact number, shipping address, and payment information when you
            register, place orders, or contact us.
          </p>
          ...
          <p>
            ...
            personalize your shopping experience, and communicate with you about
          ...
          <p>
            We use cookies to enhance site functionality and user experience.
          ...
          <p>
            ...
            information. Contact us if you wish to make such requests.
          </p>
